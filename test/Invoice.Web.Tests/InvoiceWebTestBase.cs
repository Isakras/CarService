...
namespace Invoice.Web.Tests;

public abstract class InvoiceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static InvoiceWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(InvoiceWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<InvoiceDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<InvoiceDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<InvoiceDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<InvoiceDbContext, Task<T>> func)
    {
        T result;
